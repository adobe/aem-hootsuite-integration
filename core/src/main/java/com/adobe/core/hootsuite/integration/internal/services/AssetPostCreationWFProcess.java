...
@Component(
		...
		property = { 
				"process.label=Publish Asset to Hootsuite" 
				}
		)
public class AssetPostCreationWFProcess implements WorkflowProcess {
	...
	private static final Logger log = LoggerFactory.getLogger(AssetPostCreationWFProcess.class);
	...
	public void execute(WorkItem item, WorkflowSession session, MetaDataMap args) throws WorkflowException {
		...
		try {
			...
			this.messageService.createSocialPost(resolver.getResource(item.getContentPath()).adaptTo(Asset.class),
